...
func (o *WritableVirtualMachineWithConfigContextRequest) GetStatus() ModuleRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *WritableVirtualMachineWithConfigContextRequest) GetStatusOk() (*ModuleRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritableVirtualMachineWithConfigContextRequest) SetStatus(v ModuleRequestStatus) {
	o.Status = &v
}
