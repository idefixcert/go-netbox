...
type VirtualMachineWithConfigContextStatus struct {
	Value                *ModuleRequestStatus                        `json:"value,omitempty"`
...
func (o *VirtualMachineWithConfigContextStatus) GetValue() ModuleRequestStatus {
...
func (o *VirtualMachineWithConfigContextStatus) GetValueOk() (*ModuleRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given ModuleRequestStatus and assigns it to the Value field.
func (o *VirtualMachineWithConfigContextStatus) SetValue(v ModuleRequestStatus) {
	o.Value = &v
}
